        ...
        <div className="prose prose-lg max-w-none space-y-8">
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 mb-4">
              ...
              <li><strong>Dades de contacte:</strong> Telèfon, adreça postal</li>
              <li><strong>Dades de navegació:</strong> Adreça IP, tipus de navegador, pàgines visitades</li>
              <li><strong>Dades de salut (si escau):</strong> Informació sobre condició física, objectius de salut, historial mèdic rellevant per al servei</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 mb-4">
              ...
              <li>Comunicació amb els clients i resolució de consultes</li>
              <li>Gestió de cites i seguiment dels serveis contractats</li>
              <li>Enviament d'informació sobre els nostres serveis (amb el seu consentiment)</li>
              <li>Compliment d'obligacions legals i regulatòries</li>
              <li>Millora dels nostres serveis i experiència del client</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 mb-4">
              ...
              <li><strong>Execució contractual:</strong> Per a la prestació dels serveis contractats</li>
              <li><strong>Interès legítim:</strong> Per a la gestió i millora dels nostres serveis</li>
              <li><strong>Compliment legal:</strong> Quan sigui necessari per complir amb obligacions legals</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 mb-4">
              <li>Dades de clients actius: Durant la relació contractual i fins a 5 anys després</li>
              <li>Dades de contacte (consultes): Fins a 2 anys des de l'última comunicació</li>
              <li>Dades de facturació: 10 anys segons la normativa fiscal andorrana</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 mb-4">
              <li>Quan sigui necessari per a la prestació del servei contractat</li>
              <li>Per complir amb obligacions legals o requeriments de les autoritats competents</li>
              <li>Amb el seu consentiment exprés</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 mb-4">
              ...
              <li><strong>Dret de rectificació:</strong> Corregir dades inexactes o incompletes</li>
              <li><strong>Dret de supressió:</strong> Sol·licitar l'eliminació de les seves dades</li>
              <li><strong>Dret de limitació:</strong> Restringir el tractament en determinats casos</li>
              <li><strong>Dret d'oposició:</strong> Oposar-se al tractament de les seves dades</li>
              <li><strong>Dret de portabilitat:</strong> Obtenir les seves dades en format estructurat</li>
            </ul>
            <p className="mb-4">
              Per exercir aquests drets, pot contactar-nos a través de: <strong>info@trainingtime.ad</strong>
            </p>
          </section>
